...
public abstract class Scraper {
	...
	/**
	 * Ritorna una lista di annunci. Riesce a indagare il sito giusto in base
	 * alla url
	 * 
	 * @param url
	 *            http che contine il sito e tutti i parametri di ricerca
	...
	public static List<Annuncio> getAnnunciFrom(String url) throws IOException {
		...
		/*
		 * template pattern alcuni passi dell'algoritmo sono dichiarati astratti
		 * e verranno implementati dalle sottoclassi
		 */
	...
	protected Date parseDate(String dateString) {
		...
		try {
			...
			log.error(String
					.format("Problemi nel parsing della data %s ritorno la data minima, motivo %s",
							dateString, e));
			return (new Date(0));
		}
		return date;
